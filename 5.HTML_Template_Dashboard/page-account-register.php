...
<html lang="en">
  ...
  <body>
    ...
    <p class="text-center small text-muted mb-15">o regístrate con</p>
    <div class="d-flex gap-2 mb-4">
        <a class="w-50 btn btn-light font-sm" href="#">
    ...
    <p class="text-center mb-2">¿Ya tienes una cuenta?<a href="page-account-login.php"> Inicia sesión ahora</a></p>
</form>
          </div>
        </div>
      </section>
