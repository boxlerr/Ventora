<div class="footer-1">
    <div class="container">
        ...
        <div class="col-lg-3 width-20 mb-30">
            <h4 class="mb-30 color-gray-1000" data-section="footer" data-value="servicios">Servicios</h4>
        ...
        <div class="col-lg-3 width-23">
            <h4 class="mb-30 color-gray-1000" data-section="footer" data-value="medios_de_pago">Medios de pago</h4>
            <div>
            <p class="font-md color-gray-900 mt-20 mb-10" data-section="footer" data-value="aceptamos">Aceptamos:</p><img src="assets/imgs/template/payment-method.png" alt="Ecom">
            </div>
        </div>
        </div>
    </div>
