        ...
        <div class="main-header">
            <div class="header-left">
                ...
                <div class="header-nav">
                    <nav class="nav-main-menu d-none d-xl-block">
                        <ul class="main-menu">
                            ...
                            <li><a href="shop-vendor-list.php">Marcas</a></li>
                ...
                <div class="header-shop">
                    ...
                    ?>
                        <div class="d-inline-block box-dropdown-cart"><span class="font-lg icon-list icon-cart"><span>Carrito</span><?php if ($carrito[0] > 0) {
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <nav class="mt-15">
                        <ul class="mobile-menu font-heading">
                            ...
                            <li class="has-children"><a href="shop-vendor-list.php">Vendors</a>
                                <ul class="sub-menu">
                                    <li><a href="shop-vendor-list.php">Vendors Listing</a></li>
